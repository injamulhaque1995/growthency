...
function ClerkDesktopAuth() {
  ...
  return isSignedIn ? (
    ...
    <>
      ...
      <Link href="/contact" className="btn-primary text-sm px-4 py-2">Get Started</Link>
    </>
  )
}
...
function ClerkMobileAuth() {
  ...
  return isSignedIn ? (
    ...
    <div className="p-4 border-t border-[var(--border-default)] flex flex-col gap-2">
      ...
      <Link href="/contact" className="btn-primary w-full text-sm py-2.5 text-center">Get Started</Link>
    </div>
  )
}
    ...
    <>
      <header
        className={cn(
          ...
          scrolled
            ? "backdrop-blur-md bg-[var(--bg-primary)]/80 border-b border-[var(--border-default)] shadow-[0_4px_24px_rgba(0,0,0,0.08)]"
            : "bg-transparent"
        )}
      >
