...
function ClerkDesktopAuth() {
  ...
  return isSignedIn ? (
    ...
    <>
      ...
      <Link href="/15-minute-meeting" className="btn-primary text-sm px-4 py-2">Book a Call</Link>
    </>
  )
}
...
function ClerkMobileAuth() {
  ...
  return isSignedIn ? (
    ...
    <div className="p-4 border-t border-[var(--border-default)] flex flex-col gap-2">
      ...
      <Link href="/15-minute-meeting" className="btn-primary w-full text-sm py-2.5 text-center">Book a Call</Link>
    </div>
  )
}
