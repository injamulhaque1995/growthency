  ...
  while (i < lines.length) {
    ...
    if (line.startsWith("## ")) {
      elements.push(
        <h2
          key={i}
          className="font-[family-name:var(--font-syne)] font-extrabold text-xl lg:text-2xl text-[#F0F4FF] mt-10 mb-4"
        >
          {line.slice(3)}
        </h2>
      )
      ...
      elements.push(
        <h3
          key={i}
          className="font-[family-name:var(--font-syne)] font-extrabold text-lg text-[#F0F4FF] mt-6 mb-3"
        >
          {line.slice(4)}
        </h3>
      )
      ...
      <article className="min-h-screen bg-[#050810]">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12">
            ...
            {/* Title */}
            <h1 className="font-[family-name:var(--font-syne)] font-extrabold text-3xl sm:text-4xl lg:text-5xl text-[#F0F4FF] leading-tight mb-6">
              {post.title}
            </h1>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex gap-12">
            ...
            <div className="flex-1 min-w-0 max-w-3xl">
              ...
              <div className="mt-6 p-5 bg-[#0A0F1E] border border-[#1A2440] rounded-2xl flex items-start gap-4">
                ...
                <div>
                  <p className="font-[family-name:var(--font-syne)] font-extrabold text-sm text-[#F0F4FF] mb-1">
                    {post.author.name}
                  </p>
          ...
          {relatedPosts.length > 0 && (
            <div className="mt-16 pt-10 border-t border-[#1A2440]">
              <h2 className="font-[family-name:var(--font-syne)] font-extrabold text-xl text-[#F0F4FF] mb-6">
                Related Articles
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {relatedPosts.map((related) => (
                  ...
                  >
                    ...
                    <h3 className="font-[family-name:var(--font-syne)] font-extrabold text-sm text-[#F0F4FF] mt-3 mb-2 group-hover:text-[#00A8FF] transition-colors leading-snug">
                      {related.title}
                    </h3>
